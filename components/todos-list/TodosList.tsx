...
export const TodosList: FC<Props> = ({ todos }) => {
  return (
    <ul role="list" className="flex flex-1 flex-col  divide-slate-200 rounded border bg-white p-3">
      {todos.map((todo, i) => (
        <li
          key={i}
          className="group/item flex items-center justify-between rounded hover:bg-slate-100">
